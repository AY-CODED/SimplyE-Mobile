    ...
    <div className="px-6 md:px-16 lg:px-24 py-20 bg-gradient-to-b from-gray-50 to-gray-100 pt-32">
      ...
      <div className="text-center mb-14">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto text-lg leading-relaxed">
          Explore our stylish, eco-friendly electric bikes 🚲. Whether for commuting,
          delivery, or adventure, there’s a perfect ride waiting for you.
        </p>
      </div>
        ...
        {bikes.map((bike, index) => (
          ...
          >
            ...
            <div className="p-6">
              ...
              <p className="text-gray-600 mb-4 text-sm line-clamp-2">{bike.desc}</p>

              <div className="flex items-center justify-between">
                <span className="text-blue-700 font-bold text-lg">{bike.price}</span>
                <Link
                  to={bike.path}
